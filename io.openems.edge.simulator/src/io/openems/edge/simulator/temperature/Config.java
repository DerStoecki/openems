...
@interface Config {
    ...
    @AttributeDefinition(name = "Datasource-ID", description = "ID of Simulator Datasource.",
            options = {
                    @Option(label = "primary Forward", value = "temperature-standard-load-profile-primary-Forward"),
                    @Option(label = "primary Rewind", value = "temperature-standard-load-profile-primary-Rewind"),
                    @Option(label = "secundary Forward", value = "temperature-standard-load-profile-secundary-Forward"),
                    @Option(label = "secundary Rewind", value = "temperature-standard-load-profile-secundary-Rewind"),
                    @Option(label = "Overseer", value = "temperature-standard-load-profile-overseer-temperature")
            })
    String datasource_id() default "temperature-standard-load-profile-primary-Forward";
