...
public interface HeatpumpAlphaInnotecChannel extends HeatpumpSmartGridGeneralizedChannel {
    ...
    public enum ChannelId implements io.openems.edge.common.channel.ChannelId {
         ...
         */
        DI_0_EVU(Doc.of(OpenemsType.BOOLEAN)),

        /**
         * EVU2. Like EVU, but triggered because of smart grid setting.
         */
        DI_1_EVU2(Doc.of(OpenemsType.BOOLEAN)),

        /**
         * SWT, Schwimmbadthermostat.
         */
        DI_2_SWT(Doc.of(OpenemsType.BOOLEAN)),

        /**
         * VD1, Verdichter 1.
         */
        DI_3_VD1(Doc.of(OpenemsType.BOOLEAN)),

        /**
         * VD2, Verdichter 2.
         */
        DI_4_VD2(Doc.of(OpenemsType.BOOLEAN)),

        /**
         * ZWE1, zusätzlicher Wärmeerzeuger 1.
         */
        DI_5_ZWE1(Doc.of(OpenemsType.BOOLEAN)),

        /**
         * ZWE2, zusätzlicher Wärmeerzeuger 2.
         */
        DI_6_ZWE2(Doc.of(OpenemsType.BOOLEAN)),

        /**
         * ZWE3, zusätzlicher Wärmeerzeuger 3. Optional, depends on heat pump model if available.
         */
        DI_7_ZWE3(Doc.of(OpenemsType.BOOLEAN)),
         ...
         */
        IR_22_UEBERHITZ(Doc.of(OpenemsType.INTEGER).unit(Unit.DEZIDEGREE_CELSIUS)),

        /**
         * Überhitzung Soll.
         * <li>Unit: Dezidegree Kelvin</li>
         */
        IR_23_UEBERHITZSOLL(Doc.of(OpenemsType.INTEGER).unit(Unit.DEZIDEGREE_CELSIUS)),
         ...
         */
        IR_38_WHHEIZUNG(Doc.of(OpenemsType.INTEGER)),

        /**
         * Wärmemenge Trinkwarmwasser. 32 bit unsigned doubleword. IR 40 is high, IR 41 is low.
         * <li>Unit: kWh * 10E-1</li>
         */
        IR_40_WHTRINKWW(Doc.of(OpenemsType.INTEGER)),
         ...
         * <li>Unit: kWh * 10E-1</li>
         */
        IR_42_WHPOOL(Doc.of(OpenemsType.INTEGER)),

        /**
         * Wärmemenge gesamt. 32 bit unsigned doubleword. IR 44 is high, IR 45 is low.
         * <li>Unit: kWh * 10E-1</li>
         */
        IR_44_WHTOTAL(Doc.of(OpenemsType.INTEGER)),
    ...
    default Channel<Integer> getUeberhitzungKelvin() { return this.channel(ChannelId.IR_22_UEBERHITZ); }

    default Channel<Integer> getUeberhitzungSollKelvin() { return this.channel(ChannelId.IR_23_UEBERHITZSOLL); }
