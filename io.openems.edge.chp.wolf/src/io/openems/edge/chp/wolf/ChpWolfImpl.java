...
import io.openems.edge.chp.wolf.api.ChpWolfChannel;
...
public class ChpWolfImpl extends AbstractOpenemsModbusComponent implements OpenemsComponent, EventHandler, ChpWolfChannel {
	...
	protected ModbusProtocol defineModbusProtocol() {
		...
		return new ModbusProtocol(this,
				...
				new FC3ReadRegistersTask(27, Priority.LOW,
						m(ChpBasic.ChannelId.FORWARD_TEMP, new UnsignedWordElement(0),
								ElementToChannelConverter.DIRECT_1_TO_1),
						m(ChpBasic.ChannelId.REWIND_TEMP, new UnsignedWordElement(0),
								ElementToChannelConverter.DIRECT_1_TO_1)
				),
				...
				new FC3ReadRegistersTask(263, Priority.HIGH,
						m(ChpBasic.ChannelId.ELECTRICAL_POWER, new UnsignedWordElement(0),
								ElementToChannelConverter.DIRECT_1_TO_1)
				),
				...
				new FC3ReadRegistersTask(6358, Priority.LOW,
						m(ChpWolfChannel.ChannelId.HR6358_POWER_SETPOINT, new UnsignedWordElement(0),
								ElementToChannelConverter.DIRECT_1_TO_1),
						m(ChpWolfChannel.ChannelId.HR6359_EINSPEISEMANAGEMENT_SETPOINT, new UnsignedWordElement(1),
								ElementToChannelConverter.DIRECT_1_TO_1),
						m(ChpWolfChannel.ChannelId.HR6360_RESERVE_SETPOINT, new UnsignedWordElement(2),
								ElementToChannelConverter.DIRECT_1_TO_1),
						m(ChpBasic.ChannelId.ON_OFF, new UnsignedWordElement(3),
								ElementToChannelConverter.DIRECT_1_TO_1)
				),
	...
	protected void channelmapping() {
		...
		if (debug) {
			...
			this.logInfo(this.log, "");
			this.logInfo(this.log, "Vorlauf Temperatur: " + (getForwardTemp().value().orElse(0) / 10.0) + "°C");
			this.logInfo(this.log, "Rücklauf Temperatur: " + (getRewindTemp().value().orElse(0) / 10.0) + "°C");
			...
			this.logInfo(this.log, "Elektrische Leistung: " + getElectricalPower().value().get() + " kW");
			...
			this.logInfo(this.log, "Sollwert elektrische Leistung in kW: " + setPowerSetpointChannel().value().get());
			this.logInfo(this.log, "Sollwert Einspeisemanagement: " + setEinspeisemanagementSetpointChannel().value().get());
			this.logInfo(this.log, "Reserve: " + setReserveSetpointChannel().value().get());
			this.logInfo(this.log, "On / Off: " + setOnOff().value().get());
			this.logInfo(this.log, "");
		}
