...
@ObjectClassDefinition(//
		name = "Controller Api Modbus-Slave/Serial Custom", //
		description = "This controller provides a Modbus-Slave/Serial api.")
@interface ConfigSerialCustom {
	...
	String webconsole_configurationFactory_nameHint() default "Controller Api Modbus-Slave/Serial Custom [{id}]";
}