...
public enum ChpType {
    ...
    ChpType(int percentageRange, int minValueAmpere, int maxValueAmpere, float electricalOutput, float thermalOutput, float fuelUse, int maxFlowTemperature, int maxReturnTemperature, int warmingPerformanceTolerance, float warmingPerformance100Percent, float warmingPerformance75Percent, float warmingPerformance50Percent, String name) {
